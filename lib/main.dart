...
// PdfFont font = PdfStandardFont(fontFamily, size);
  // PdfFont font = PdfTrueTypeFont(
  //     File('/assets/fonts/Pyidaungsu_Regular.ttf').readAsBytesSync(), 24);
// PdfFont font = PdfTrueTypeFont(Server.MapPath("/App_Data/ARIALUNI.ttf"), 24);
//Drawing the Unicode string.
// page.Graphics.DrawString("Hello PDF Sample", font, PdfBrushes.Black, 100, 100);
  ...
  PdfLayoutResult drawHeader(PdfPage page, Size pageSize, PdfGrid grid) {
    ...
    page.graphics.drawString(
        // 'အခွင့်အရေး အပေးအယူ',
        // PdfTrueTypeFont(
        //     File('Pyidaungsu_Regular.ttf').readAsBytesSync(), 24),
        // 'အခွင့်အရေး အပေးအယူ',
        // PdfTrueTypeFont(
        //     File('assets/fonts/Pyidaungsu_Regular.ttf').readAsBytesSync(), 24),
        // 'အခွင့်အရေး အပေးအယူ', PdfStandardFont(PdfFontFamily.zapfDingbats, 30),
        // 'အခွင့်အရေး အပေးအယူ', PdfStandardFont(PdfFontFamily.courier, 30),
        // 'အခွင့်အရေး အပေးအယူ', PdfStandardFont(PdfFontFamily.timesRoman, 30),
        'INVOICE',
